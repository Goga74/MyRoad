...
public class MRDefaults {
	final static String LOGTAG = "MyRoad";	
	...
	static final String MR_SMS_SIGN = "myroad.sms_body";
	static final String MR_SMS_SER = "myroad.point_full";
	...
	static final String baseURL = "http://myroad.info";
	static final String appTitle = "MyRoad Tracker";
	final static String MYFOLDER = "myroad";
